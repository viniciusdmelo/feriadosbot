...
url_ano_atual = 'https://www.feriados.com.br/feriados-belo_horizonte-mg.php'
...
feriados_mg_ano_atual = []
for data in feriados_ano_atual:
    feriado = data.text
    feriados_mg_ano_atual.append(feriado)

facultativos_ano_atual = html_feriados_ano_atual.findAll('span', {'class':'style_lista_facultativos'})
facultativos_mg_ano_atual = []
for data in facultativos_ano_atual:
    facultativo = data.text
    facultativos_mg_ano_atual.append(facultativo)

datas_comemorativas_ano_atual = feriados_mg_ano_atual + facultativos_mg_ano_atual
