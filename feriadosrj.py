...
url_ano_atual = 'https://www.feriados.com.br/feriados-rio_de_janeiro-rj.php'
...
feriados_rj_ano_atual = []
for data in feriados_ano_atual:
    feriado = data.text
    feriados_rj_ano_atual.append(feriado)

facultativos_ano_atual = html_feriados_ano_atual.findAll('span', {'class':'style_lista_facultativos'})
facultativos_rj_ano_atual = []
for data in facultativos_ano_atual:
    facultativo = data.text
    facultativos_rj_ano_atual.append(facultativo)

datas_comemorativas_ano_atual = feriados_rj_ano_atual + facultativos_rj_ano_atual
